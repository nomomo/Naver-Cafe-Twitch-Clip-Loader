...
- Youtube 동영상에 대해 게으른 로딩 방식을 적용하여 Youtube 동영상이 많은 글에서 속도가 느려지는 것을 개선합니다.
- Youtube 클립 로드를 실패하는 경우 알림창으로 알립니다.
- Youtube 클립의 경우, 섬네일 대신 스토리보드를 표시합니다.
- [실험실] 볼륨 컨트롤러를 항상 표시 옵션 추가
- 내부 재작업 및 정리
