...
- ﻿Youtube 관련 기능이 추가되었으며, 이로 인해 스크립트 실행 조건이 변경되어 자동 업데이트 될 때 확인 창이 뜰 수 있습니다.
- Youtube 와 관련된 기능이 추가 (기본값으로 꺼져있으므로, 필요하신 분은 상세 설정에서 켜주세요.)
...
- Naver Video 관련 기능 추가
  ...
  - 네이버 비디오의 크기를 본문에 맞추고, 16:9 비율로 고정할 수 있는 기능이 추가되었습니다.
