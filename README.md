...
- 네이버 카페는 Youtube 링크를 카페 글 내에서 바로 볼 수 있도록 비디오로 자동 변환하는 기능을 지원하지만, Twitch Cilp 의 경우에는 해당 기능을 지원하지 않습니다. 본 스크립트는 네이버 카페 글에서 Twitch 클립 링크를 감지하는 경우, 재생 가능한 비디오로 변환해주는 브라우저 확장 UserScript 입니다.
